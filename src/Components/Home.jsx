...
const Home = () => {
  return (
    <div
      name="home"
      className="h-screen w-full bg-gradient-to-b 	bg-slate-300	 from-white via-skin to-white-800"
    >
      <div className="max-w-screen-lg mx-auto flex flex-col items-center justify-center h-full px-4 md:flex-row">
        <div className="flex flex-col mt-20 justify-center h-full">
          <h2 className="text-4xl mt-20 sm:text-7xl font-bold text-pink-700 ">
        ...
        <div >
          <img
            ...
            className="rounded-full mt-20  mx-auto w-2/3 md:w-40px"
